    ...
    new GoogleStrategy(
        {
            ...
            callbackURL: process.env.GOOGLE_CALLBACK_URL || "http://localhost:5000/manora/auth/google/callback",
            proxy: true,
        },
        ...
        new GitHubStrategy(
            {
                ...
                callbackURL: process.env.GITHUB_CALLBACK_URL || "http://localhost:5000/manora/auth/github/callback",
                proxy: true,
                scope: ["user:email"],
            },
            async (accessToken, refreshToken, profile, done) => {
